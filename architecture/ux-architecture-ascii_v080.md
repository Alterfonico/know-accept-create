...
# THREE-ACT LOOP · as of v0.15.0 · 2026-03-09
...
╚══════════════════════════════════════════════════════════════════╝
  ...
  App re-entry ──▶ [ 🪵 ]  ◀── this is the capture surface
                  ...
                  [ save for now ] → stays on 🪵 · clears draft
                      ...
                      │                   post-send signal: OPEN QUESTION
                      │                   breath cue removed v0.9.0
                      │                   placeholder text replacement decided S27
                      │                   not yet implemented · silence is current state
                      │
