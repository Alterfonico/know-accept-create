...
const SEED = [
  {
    id: "e1", text: "tired in a way that sleep doesn't fix",
    created_at: new Date(NOW - DAY * 3 + HR * 23).toISOString(),
    voltage: VOLTAGE[1], confidence: 0.89,
    analysis: "Structural fatigue. Not rest deficit — meaning deficit. The two look identical from inside.",
    device: "mobile", source: "app", isOrigin: false, children: [],
  },
  {
    id: "e2", text: "talked to someone who actually listened. forgot that was possible.",
    created_at: new Date(NOW - DAY * 2 + HR * 18).toISOString(),
    voltage: VOLTAGE[0], confidence: 0.94,
    analysis: "The surprise in \"forgot that was possible\" is the signal. The baseline shifted somewhere, and you just noticed the distance.",
    device: "mobile", source: "app", isOrigin: false, children: [],
  },
  {
    id: "e3", text: "here",
    created_at: new Date(NOW - DAY + HR * 7.5).toISOString(),
    voltage: VOLTAGE[2], confidence: 0.62,
    analysis: "Presence without content. That's contact. The system registered you were here.",
    device: "mobile", source: "android", isOrigin: false, children: [],
  },
  {
    id: "e4", text: "I keep cancelling things I actually want to do",
    created_at: new Date(NOW - DAY + HR * 22).toISOString(),
    voltage: VOLTAGE[1], confidence: 0.91,
    analysis: "The erosion is in the gap between wanting and doing. That gap has a shape. This is the third time it has appeared this week.",
    device: "mobile", source: "app", isOrigin: false, children: [],
  },
  {
    id: "e5", text: "something is shifting and I can't quite name it yet",
    created_at: new Date(NOW - HR * 2).toISOString(),
    voltage: VOLTAGE[0], confidence: 0.87,
    analysis: "Something unnamed is in motion. The fact that you can feel it without labeling it is its own signal.",
    device: "computer", source: "app", isOrigin: true, children: [],
  },
];
      ...
      >
        ...
        {echo.isOrigin && (
          <span style={{
            ...
            fontSize: 8, opacity: 0.3, color: v.color,
          }}>◆</span>
        )}
        ...
        <div style={{
          ...
          paddingLeft: 6, wordBreak: "break-word",
          ...(!expanded ? {
        ...
        <div style={{
          ...
          marginTop: 5, paddingLeft: 6,
        }}>
          <span style={{ fontSize: 9, letterSpacing: 1, color: T.dim }}>{time}</span>
          {v.label && (
            <span style={{ fontSize: 9, letterSpacing: 0.5, color: v.color }}>{v.label}</span>
          )}
          {echo.device && (
            <span style={{ fontSize: 8, color: T.dim, opacity: 0.45, marginLeft: "auto" }}>
              {echo.device}
            </span>
          )}
        </div>
        ...
        {expanded && (
          <div style={{
            ...
            {[
              ...
              ["confidence", echo.confidence != null ? echo.confidence.toFixed(2) : "—", null ],
              ...
              <div key={key} style={{
                ...
                <span style={{
                  fontSize: 8, letterSpacing: 1.5, color: T.dim, textTransform: "uppercase",
                }}>{key}</span>
                <span style={{
                  fontSize: 9, color: color || T.text,
                  opacity: color ? 1 : 0.55, textAlign: "right",
                }}>{val}</span>
              </div>
            ))}
            ...
            {echo.analysis && (
              <div style={{
                marginTop: 4, fontSize: 11, lineHeight: 1.7,
                fontStyle: "italic", color: "rgba(0,0,0,0.4)",
                paddingLeft: 8,
                borderLeft: `2px solid ${
                  v.key === "life"  ? "rgba(61,171,122,0.2)" :
                  v.key === "upset" ? "rgba(192,80,74,0.2)"  :
                  "rgba(0,0,0,0.08)"
                }`,
              }}>
                {echo.analysis}
            ...
            <button
              onClick={(e) => { e.stopPropagation(); onAsk(echo); }}
              style={{
                alignSelf: "flex-end",
  ...
  return (
    <>
      ...
      <div style={{
        ...
        width: "84%", background: T.bg, zIndex: 60,
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: v.key === "life"  ? "rgba(61,171,122,0.03)" :
                        v.key === "upset" ? "rgba(192,80,74,0.03)"  :
                        "rgba(0,0,0,0.02)",
          ...
          {echo.children.map((c, i) => (
            <div key={i} style={{
              ...
              <div style={{
                fontSize: 8, letterSpacing: 2, color: T.purple, marginBottom: 4,
              }}>inquiry</div>
        ...
        <div style={{
          ...
          <div style={{
            background: T.bg2, border: "1px solid rgba(0,0,0,0.12)",
            borderRadius: 50, padding: "0 6px 0 16px",
...
export default function MeverseReact() {
  ...
  function handleClosePanel() {
    setClosing(true);
    setTimeout(() => { setPanelId(null); setClosing(false); }, 250);
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: "0 0 0 1px rgba(0,0,0,0.03), 0 0 60px rgba(0,0,0,0.06), 0 40px 80px rgba(0,0,0,0.12)",
        flexShrink: 0,
      }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{
              fontFamily: T.disp, fontSize: 14, fontWeight: 800,
              color: T.text, letterSpacing: 3, lineHeight: 1.2,
            }}>ECHO CHAMBER</div>
            <div style={{
              fontSize: 9, letterSpacing: 1.5, color: T.dim, marginTop: 1,
            }}>
        ...
        <div style={{
          ...
          borderBottom: filterOpen ? `1px solid ${T.border}` : "1px solid transparent",
        }}>
        ...
        <div ref={chatRef} style={{
          ...
          {renderItems.length === 0 && (
            <div style={{
              ...
              fontSize: 10, letterSpacing: 2.5, color: T.dim,
            ...
            if (item.type === "sep") {
              return (
                <div key={item.key} style={{
                  alignSelf: "center",
                  fontSize: 9, letterSpacing: 1.8, color: T.dim,
                  background: T.bg2,
                  border: `1px solid ${T.border}`,
                  borderRadius: 20,
                  padding: "3px 10px",
        ...
        <div style={{
          ...
          letterSpacing: 1.5, color: "rgba(0,0,0,0.12)",
          zIndex: 0, pointerEvents: "none",
        }}>v0.30.0 · echo chamber · capture-echo wired</div>
      </div>
    </div>
  );
}
